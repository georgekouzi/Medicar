...
class ReminderActivity : SimpleActivity() {
    ...
    private var alarm: com.simplemobiletools.clock.models.Alarm? = null
...
//        updateTextColors(reminder_holder as ViewGroup)
        Log.d("test65445", "ReminderActivity")
    ...
    private fun snoozeAlarm() {
        destroyEffects()
        Log.d("test65445","snoozeAlarm")
        setupAlarmClock(alarm!!, DEFAULT_MAX_ALARM_REMINDER_SECS * MINUTE_SECONDS)
        finishActivity()
